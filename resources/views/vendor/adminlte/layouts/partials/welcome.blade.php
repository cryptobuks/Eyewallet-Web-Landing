                ...
                <div class="col-md-12">
                    <div class="hello_slid">
                        <div class="slid_item xs-text-center">
                            ...
                            <div class="col-sm-6">
                                <img class="img2" src="assets/images/celular-25.png" alt=""/>
                                <img class="img1" src="assets/images/celular-55.png" alt=""/>
                            </div>
        ...
        <div class="container m-bottom-100">
            <div class="row row-news-al">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col2-res-news">
                    <img src="assets/images/WEB 3final-23.png" alt="">
                    <h4 class="text-white  news">Declaraciones engañosas en Bitmain</h4>
                    <h6 class="text-white text-res-det">Declaraciones vagas en los inversores del gigante...</h6>
                    <h6 class="text-white text-read">LEER MÁS</h6>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-res-news">
                    <img src="assets/images/WEB 3final-24.png" alt="">
                    <h2 class="text-white text-res-ti">El banco de Tailandia anuncia el proyecto "Hito"</h2>
                    <h5 class="text-white text-res-det">El BoT ha revelado en un comunicacdo de prensa de agosto sus
                        planes para desarrollar una moneda...</h5>
                    <h6 class="text-white text-read">LEER MÁS</h6>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <img src="assets/images/WEB 3final-22.png" alt="">
                    <h4 class="text-white text-res-ti">Los volúmenes de Binance y OKEx aumentan</h4>
                    <h6 class="text-white text-res-det">La mayor bolsa de ciptodivisas de Estados Unidos se
                        enfrenta...</h6>
                    <h6 class="text-white text-read">LEER MÁS</h6>
                    <img src="assets/images/WEB 3final-21.png" alt="">
                    <h4 class="text-white text-res-ti">Dash: "Venezuela es el 2do Mercado más grande"</h4>
                    <h6 class="text-white text-res-det">Venezuela se ha convertido en el mercado más grande para
                        Dash, casi cien comerciantes...</h6>
                    <h6 class="text-white text-read">LEER MÁS</h6>
                </div>
            </div>
        </div>
    ...
    <div class="main_footer fix text-center p-top-40 p-bottom-30 ">
        ...
        <div class="col-lg-12 col-md-5 col-sm-6 col-xs-12 col-res-foot">
            ...
            <div class="container m-top-20 m-bottom-20">
                <a class="m-lr-15">Legal</a>
                <a class="m-lr-15">Privacy</a>
                <a class="m-lr-15">Policies</a>
            </div>
        </div>
        <div class="col-lg-12 col-md-5 col-sm-6 col-xs-12 col-res-foot">
